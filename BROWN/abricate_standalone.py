...
Comprehensive ABRicate analysis with HTML and summary.tsv reporting only
...
class AbricateExecutor:
    """ABRicate executor with comprehensive HTML reporting"""
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='StaphScope ABRicate Analysis - Comprehensive HTML Reporting',
...
Examples:
  ...
  python abricate_standalone.py "MRSA_*.fna" --threads 8
...
Supported FASTA extensions: .fasta, .fa, .fna, .faa
    ...
    parser.add_argument('--output', '-o', default='abricate_results', help='Output directory (default: abricate_results)')
    
    args = parser.parse_args()
    
    executor = AbricateExecutor(threads=args.threads)
